...
const (
	...
	apiPath      = "/service/audioPlayer/api/v1/secure/playlist/remove/batch"
...
func main() {
	...
	for res := range attacker.Attack(targeter, rate, testDuration, "批量删除曲目压测") {
		metrics.Add(res)
